...
from lightgcn_for_tag.datasets import prepare_dataset
from lightgcn_for_tag.models import build, train
from lightgcn_for_tag.utils import class2dict, get_logger, setSeeds
...
#sweep_id = wandb.sweep(config.sweep_config, project="dkt_lgbm", entity="esk1")  ##추가
if __name__ == "__main__":
#    wandb.agent(sweep_id, main(), count=18) ##추가
    main()
