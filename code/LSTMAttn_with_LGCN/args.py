...
def parse_args(mode="train"):
    ...
    parser.add_argument("--run", default='model')
    ...
    parser.add_argument(
        "--test_file_name", default="new_test_data.csv", type=str, help="test file name"
    )
    ...
    parser.add_argument("--use_wandb", default='o', type=str)
